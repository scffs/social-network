...
export const registerSchema = yup.object().shape({
  ...
  age: yup.number().typeError('Возраст должен быть числом').min(14, 'Возраст должен быть больше или равен 14').max(100, 'Возраст должен быть меньше или равен 100').required('Заполните поле'),
